...
class Utilisateur extends Authenticatable {
    ...
    public function displayName() {
        ...
        if ((DB::table('particulier')->where('idparticulier', $id)->exists() && $this->particulier->piece_identite != null && $this->particulier->Utilisateur->telephone_verifie) || DB::table('entreprise')->where('identreprise', $id)->exists()) {
