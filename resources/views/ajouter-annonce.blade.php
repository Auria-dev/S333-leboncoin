...
@section('content')
    ...
    <form method="POST" action="{{ url('ajouter_annonce') }}" style="display: flex; flex-direction: column; width: 700px; ">
        ...
        <input type="number" id="nb_nuits" name="nb_nuits" placeholder="2" required>

        <label>Nombre de personness maximum</label>
        <input type="number" id="nb_pers" name="nb_pers" placeholder="4" required>

        <label>Nombre de bébés maximum</label>
        <input type="number" id="nb_bebes" name="nb_bebes" placeholder="2" required>

        <label>Nombre d'animaux maximum</label>
        <input type="number" id="nb_animaux" name="nb_animaux" placeholder="2" required>

        <label>Nombre de chambre</label>
        <input type="number" id="nb_chambres" name="nb_chambres" placeholder="3" required>
