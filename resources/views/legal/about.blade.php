...
@section('title', 'Qui sommes-nous ? - Leboncoin')
...
<div class="legal-wrapper">
    <div class="legal-card">
        ...
        <div style="text-align: center; margin-bottom: 60px;">
            <img src="{{ asset('assets/logo.svg') }}" alt="Leboncoin Groupe" style="height: 60px; margin-bottom: 24px;">
        ...
        <div style="line-height: 1.8; color: #4a4a4a; text-align: justify; font-size: 16px;">
            ...
            <section style="margin-bottom: 60px;">
                ...
                <p style="margin-bottom: 20px;">
                    Fondé en 2006, <strong>Leboncoin</strong> est né d'une ambition simple : permettre à chacun de tout vendre et de tout acheter, près de chez soi. Initialement filiale du groupe de médias norvégien Schibsted, Leboncoin a connu une croissance exponentielle pour devenir le 1er site de vente entre particuliers en France.
                </p>
                <p>
