...
@section('title', 'Mentions Légales - Lemauvaiscoin')
    ...
    <div class="legal-card">
        ...
        <div style="line-height: 1.8; color: #4a4a4a; font-size: 15px;">
            ...
            <p style="margin-bottom: 30px;">
                Conformément aux dispositions des articles 6-III et 19 de la Loi n° 2004-575 du 21 juin 2004 pour la Confiance dans l'Économie Numérique (LCEN), nous portons à la connaissance des utilisateurs et visiteurs du site <strong>Lemauvaiscoin.fr</strong> les informations suivantes :
            </p>
            ...
            <div style="margin-bottom: 40px; border: 1px solid #e2e8f0; border-radius: 12px; padding: 30px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px;">
                    <div>
                        ...
                        Lemauvaiscoin SAS (Société par Actions Simplifiée)
                    ...
                    <div>
                        ...
                        support@Lemauvaiscoin.fr / +33 1 40 00 00 00
                    </div>
                </div>
                <p style="margin-top: 20px; border-top: 1px solid #eee; padding-top: 20px;">
                    ...
                    <strong>Responsable de la rédaction :</strong> Service Communication Lemauvaiscoin.
                </p>
            </div>
            ...
            <div style="margin-bottom: 20px; border: 1px solid #e2e8f0; border-radius: 12px; padding: 30px;">
                ...
                <p style="margin-bottom: 15px;">
                    La structure générale du site <em>Lemauvaiscoin.fr</em>, ainsi que les textes, graphiques, images, sons et vidéos la composant, sont la propriété exclusive de la société Lemauvaiscoin SAS ou de ses partenaires. Toute représentation et/ou reproduction et/ou exploitation partielle ou totale de ce site, par quelque procédé que ce soit, sans l'autorisation préalable et par écrit de la société Lemauvaiscoin SAS est strictement interdite et serait susceptible de constituer une contrefaçon au sens des articles L 335-2 et suivants du Code de la propriété intellectuelle.
                </p>
                <p>
                    Les marques "Lemauvaiscoin", "Adevinta" sont des marques déposées. Toute représentation et/ou reproduction et/ou exploitation partielle ou totale de ces marques, de quelque nature que ce soit, est totalement prohibée.
                </p>
            </div>
        </div>
    </div>
