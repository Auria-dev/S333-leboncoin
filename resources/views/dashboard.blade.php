        ...
        <div class="dashboard-container">
            ...
            <div class="side-by-side dashboard-header">
                ...
                <div class="flex-col-gap-sm">
                    ...
                    <p>Bienvenue dans le tableau de bord de votre compte
                        {{ strtolower($utilisateur->getTypeParticulier()) }}.</p>
            ...
            @if (!$utilisateur->hasVerifiedEmail())
                <div class="mailwarning">
                    ...
                    <h3>Veuillez cliquer sur le lien de confirmation envoyé par e-mail pour accéder à toutes les
                        fonctionnalités du site.</h3>
            ...
            @if ($utilisateur->administrateur && $utilisateur->administrateur->typeAdmin->nom_type_admin === 'Service Immobilier')
                <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
                    <h3 style="margin-bottom: 1.5rem;">Espace Service Immobilier</h3>
            ...
            @if (
                $utilisateur->administrateur &&
                    $utilisateur->administrateur->typeAdmin->nom_type_admin === 'Service Petites Annonces')
                <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
                    <h3 style="margin-bottom: 1.5rem;">Espace Service Petites Annonces</h3>
            ...
            @if ($utilisateur->administrateur && $utilisateur->administrateur->typeAdmin->nom_type_admin === 'Service Location')
                <div style="margin-top: 30px; padding-top: 20px;">
                    <h3 style="margin-bottom: 1.5rem;">Espace Service Location</h3>
            ...
            @if ($utilisateur->administrateur && $utilisateur->administrateur->typeAdmin->nom_type_admin === 'Service Comptable')
                <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
                    <h3 style="margin-bottom: 1.5rem;">Espace Service Comptable</h3>
            ...
            @if ($utilisateur->administrateur && $utilisateur->administrateur->typeAdmin->nom_type_admin === 'DPO')
                <div class="res-section">
                    <p class="section-title" style="display: flex; justify-content: space-between; align-items: center;">
                        Console DPO - RGPD
                        <span
                            style="background: #f1f5f9; color: #64748b; font-size: 11px; padding: 4px 8px; border-radius: 4px; font-weight: normal;">ADMIN</span>
                    </p>
